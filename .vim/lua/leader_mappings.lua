local leader_mappings = {
  ...
  { mode = 'nnoremap <silent>', keys = {'g', 'a'}, action = ':Gwrite<CR>', description = 'Git add' },
  { mode = 'nnoremap <silent>', keys = {'g', 'g'}, action = ':Git<Space>', description = 'Git command' },
  { mode = 'nnoremap <silent>', keys = {'g', 'l'}, action = ':Glog<CR>', description = 'Git log' },
  { mode = 'nnoremap <silent>', keys = {'g', 'L'}, action = ':Glog -- %<CR>', description = 'Git file log' },
  ...
  { mode = 'nnoremap <silent>', keys = {'g', 'h', 'c'}, action = ':Commits!<CR>', description = 'Commit history' },
  { mode = 'nnoremap <silent>', keys = {'g', 'h', 'f'}, action = ':BCommits!<CR>', description = 'Buffer commit history' },
  { mode = 'nnoremap <silent>', keys = {'g', 'h', 'b'}, action = ':Gblame<CR>', description = 'Git blame' },
...
local function get_which_key_mappings()
  return {
    ...
    y = { name = '+yank' },
    g = { name = '+git', c = { name = '+chunk' }, h = { name = '+history' } },
    p = { name = '+project' },
    c = { 
      name = '+code', 
      c = {
