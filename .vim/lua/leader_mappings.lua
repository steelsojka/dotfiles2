local leader_mappings = {
  ...
  { mode = 'nnoremap', keys = {'/', 'd'}, action = ':lua steelvim.rg_input("DRg", "Grep from file")<CR>', description = 'Grep files in directory' },
  ...
  { mode = 'nnoremap', keys = {'/', 'p'}, action = ':lua steelvim.rg_input("Rg", "Grep project")<CR>', description = 'Grep files in project' },
  { mode = 'nnoremap', keys = {'/', 'P'}, action = ':lua steelvim.rg_input("Rg!", "Grep project")<CR>', description = 'Grep files in project (full },' },
  ...
  { mode = 'nnoremap <silent>', keys = {'g', 'S'}, action = ':lua steelvim.float_fzf_cmd("gss")<CR>', description = 'Browse stash' },
  { mode = 'nnoremap <silent>', keys = {'g', 'r'}, action = ':lua steelvim.float_fzf_cmd("grh")<CR>', description = 'Reset files to head' },
  { mode = 'nnoremap <silent>', keys = {'g', 'D'}, action = ':lua steelvim.float_fzf_cmd("gd")<CR>', description = 'Diff files' },
  { mode = 'nnoremap <silent>', keys = {'g', 'a'}, action = ':lua steelvim.float_fzf_cmd("ga")<CR>', description = 'Add files' },
