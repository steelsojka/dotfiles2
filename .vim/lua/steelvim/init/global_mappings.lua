...
local mappings = {
  ...
  -- ['i<C-j>'] = { function() completion.prevSource() end },
  -- ['i<C-k>'] = { function() completion.nextSource() end },
...
steel.mappings.register_mappings(mappings, { noremap = true }, vim.g.which_key_map)
